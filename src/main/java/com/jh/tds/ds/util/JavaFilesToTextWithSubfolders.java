...
public class JavaFilesToTextWithSubfolders {
    ...
    public static void fileWriter(String[] args) {
        ...
        String folderPath = "D:\\OSBI\\workspace\\task-mgmt-service\\src\\main\\java\\com\\jh\\tds\\tms";  // Change this to the folder path containing .java files
        
        // Output file where the content of all .java files will be written
        String outputFile = "D:\\OSBI\\workspace\\department-service\\src\\main\\resources\\output\\task-mgmt-service_7thJan2025.txt";  // Change this to your desired output file
